        ...
        <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-3">
              <a href="mailto:madawa@example.com" className="w-8 h-8 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-600 transition-colors duration-300 group">
              ...
              <a href="https://linkedin.com/in/madawa" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-600 transition-colors duration-300 group">
              ...
              <a href="https://github.com/madawa" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-600 transition-colors duration-300 group">
                <svg className="w-4 h-4 text-slate-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
