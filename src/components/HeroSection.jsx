            ...
            <div className="pt-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="group inline-flex items-center justify-center space-x-3 bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 rounded-full transition-all duration-300 font-medium"
                >
                ...
                <a 
                  ...
                  className="group inline-flex items-center justify-center space-x-3 border-2 border-teal-500 hover:border-teal-400 text-teal-400 hover:text-white hover:bg-teal-500 px-8 py-4 rounded-full transition-all duration-300 font-medium"
                >
                  <span>Contact Me</span>
                  <div className="w-6 h-6 border-2 border-teal-400 group-hover:border-white rounded-full flex items-center justify-center group-hover:bg-white transition-all duration-300">
                    <svg className="w-4 h-4 text-teal-400 group-hover:text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
